#define PWMA 3 // PWM pin for motor
#define AIN1 4 // direction pin 1
#define AIN2 5 // direction pin 2

#define PWMB 9 // PWM pin for motor
#define BIN1 11 // direction pin 1
#define BIN2 10 // direction pin 2

int pwmsig   = 255;  // PWM duty cycle (out of 255)
